...
const styles = StyleSheet.create({
  hero: { paddingTop: spacing.lg, gap: 5 }, eyebrow: { color: colors.primary, fontSize: 11, fontWeight: "900", letterSpacing: 1.3 }, logo: { color: colors.text, fontSize: 38, fontWeight: "900", letterSpacing: -2 }, accent: { color: colors.primary }, tagline: { color: colors.muted, fontSize: 15, lineHeight: 22 }, stats: { flexDirection: "row", gap: spacing.sm }, metric: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: 14, borderWidth: 1, flex: 1, padding: spacing.md }, metricValue: { color: colors.text, fontSize: 18, fontWeight: "900" }, metricLabel: { color: colors.muted, fontSize: 11, fontWeight: "700", marginTop: 2 }, sectionHead: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", marginTop: spacing.sm }, section: { color: colors.muted, fontSize: 11, fontWeight: "900", letterSpacing: 1 }, link: { color: colors.primary, fontWeight: "800" }, languages: { flexDirection: "row", flexWrap: "wrap", gap: spacing.sm }, pill: { backgroundColor: colors.surfaceRaised, borderRadius: 10, color: colors.text, fontSize: 12, fontWeight: "700", paddingHorizontal: 10, paddingVertical: 8 }
});
